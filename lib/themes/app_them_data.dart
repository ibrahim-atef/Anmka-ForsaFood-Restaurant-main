...
class AppThemeData {
  ...
  static const Color primary50 = Color(0xFFE0F2F1);  // أفتح درجة
  static const Color primary100 = Color(0xFFB2DFDB); // فاتح
  static const Color primary200 = Color(0xFF80CBC4); // متوسط فاتح
  static const Color primary300 = Color(0xFF03615F); // اللون الأساسي
  static const Color primary400 = Color(0xFF02847D); // متوسط غامق
  static const Color primary500 = Color(0xFF015D56); // اللون الرئيسي
  static const Color primary600 = Color(0xFF003D3B); // أغمق درجة
  ...
  static const Color secondary50 = Color(0xFFE0F2F1);  // أفتح درجة
  static const Color secondary100 = Color(0xFFB2DFDB); // فاتح
  static const Color secondary200 = Color(0xFF80CBC4); // متوسط فاتح
  static Color secondary300 = Color(0xFF03615F); // اللون الأساسي
  static const Color secondary400 = Color(0xFF02847D); // متوسط غامق
  static const Color secondary500 = Color(0xFF015D56); // اللون الرئيسي
  static const Color secondary600 = Color(0xFF003D3B); // أغمق درجة
  ...
  // static Color secondary300 = const Color(0xFF03615F);
