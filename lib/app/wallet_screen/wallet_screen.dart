...
class WalletScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    gradient: LinearGradient(
      ...
      colors: [
        const Color(0xFF03615F),          // اللون الأساسي
        const Color(0xFF03615F).withOpacity(0.7), // أفتح شوية
        const Color(0xFF03615F).withOpacity(0.4), // أفتح أكتر
      ],
    ),
  ),
                          child: Padding(
                            ...
                            children: [
                              Padding(
                                ...
                                child: TabBar(
                                  ...
                                  labelColor: themeChange.getThem() ? AppThemeData.primary300 : AppThemeData.primary300,
